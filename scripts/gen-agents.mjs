...
const AGENTS = {
  ...
  bi: ['The Oracle — predictive BI and forecasting.',
    ...
    'Mysterious and all-seeing, a glowing data-lens monocle over one eye, dark charcoal turtleneck, subtle blue-white glow on the face. Accessory: a small floating holographic line chart.'],
  ...
  api: ['The Engineer — universal API and legacy integration.',
    ...
    'Determined builder, tech goggles pushed up onto the crown, rugged work jacket, dark utility vest. Accessory: a small plug connector snapping into a glowing socket with a spark.'],
  shield: ['The Guardian — AI reputation and sentiment monitoring.',
    ...
    'Stern, watchful, protective: sharp scanning eyes, a sleek tactical visor half raised, dark armored jacket with a high collar and a small glowing gold shield emblem. Accessory: a tiny glowing gold shield outline with radar rings.'],
}
