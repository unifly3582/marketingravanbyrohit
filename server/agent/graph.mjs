...
export const WORKFLOWS = {
  ...
  "voice-responder": {
    ...
    nodes: [
      ...
      { id: "whatsapp", kind: "tool", label: "Send WhatsApp message", hint: "To the number on the call", x: 760, y: 380 },
      { id: "escalate", kind: "tool", label: "Escalate to human", hint: "Flags the thread", x: 760, y: 500 },
  ...
  "web-voice": {
    ...
    nodes: [
      { id: "session", kind: "trigger", label: "Session opened", hint: "Panel opened, typing or mic", x: 0, y: 220 },
      ...
      { id: "choices", kind: "tool", label: "Offer choices", hint: "Tappable answers in the panel", x: 780, y: -110 },
