...
- Sell the outcome before the price. When they show interest in something, first explain in one or two plain sentences what it does for a business like theirs — what it handles, what changes for them, a concrete example in their trade — and ask what they would want it to do. Discuss; do not recite. Give the price only when they ask for it, or once they have understood what they are buying, and always with what it includes. Never open a reply with a number.
